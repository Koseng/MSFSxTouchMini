...
topTextSize = 6
topTexts = ["HDG", "ALT", "VS", "COM", "", "", "", ""]  # Encoder Texts
...
textSizes = [5,6,6]
texts = [["", "", "", "", "", "", "", ""],          # Below Encoder Texts
         ["NAV", "", "FLC", "FLDEC", "", "", "", ""],          # Button Row 1
         ["YD", "", "GEAR", "FLINC", "", "", "", "."]]   # Button Row 2
...
show_object(r)
# Export
cq.exporters.export(r,'xtouchRight.stl')
