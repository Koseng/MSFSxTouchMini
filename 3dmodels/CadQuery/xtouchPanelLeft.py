...
topTextSize = 6
topTexts = ["BARO", "MODE", "RANGE", "SPEED", "", "", "", ""]  # Encoder Texts
...
texts = [["STD", "", "", "", "", "", "", ""],          # Below Encoder Texts
         ["FD", "", "PBRK", "AICE", "", "", "", ""],          # Button Row 1
         ["AP1", "AP2", "LS", "APPR", "", "", "", "."]]   # Button Row 2
...
show_object(r)
# Export
cq.exporters.export(r,'xtouchLeft.stl')
#cq.exporters.export(r, 'xtouchLeft.svg')